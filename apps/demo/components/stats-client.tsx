    ...
    <div className="max-w-2xl mx-auto px-6 py-12 space-y-8 sm:px-4">
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex min-w-0 items-center gap-4">
          ...
          {featuredSticker && (
            <a href={sitePath("/stickers")} className="group relative hidden flex-col items-center self-center min-[380px]:flex">
      ...
      {totalCheckins === 0 ? (
        <div className="flex justify-center">
          <span className="px-2.5 py-1 rounded-full bg-muted text-muted-foreground text-xs">⚠️ No check-ins found — run a <a href={sitePath("/home#manual-sync")} className="underline hover:opacity-70 transition-opacity">manual sync</a> or wait for a scheduled run.</span>
        </div>
      ) : (<>
